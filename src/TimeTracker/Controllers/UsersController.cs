...
namespace TimeTracker.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PageList<UserModel>>> GetPage(
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<UserModel>> Upadate(
            long id, UserInputModel model)
        {


            _logger.LogInformation($"Upating user with id {id}");
            var user = await _dbContext.Users.FindAsync(id);
