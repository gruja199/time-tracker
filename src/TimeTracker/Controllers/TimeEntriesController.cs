...
namespace TimeTracker.Controllers
{
    ...
    public class TimeEntriesController : Controller
    {
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(PageList<TimeEntryModel>))]
        public async Task<ActionResult<PageList<TimeEntryModel>>> GetPage(int page = 1, int size = 5)
        {
            ...
            return new PageList<TimeEntryModel>
            {
